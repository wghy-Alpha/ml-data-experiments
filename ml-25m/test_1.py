...
print(f"总体-长尾 余弦相似度均值: {np.mean(cos_ol_list):.4f}")
print(f"总体-热门 余弦相似度均值: {np.mean(cos_oh_list):.4f}")
print(f"长尾-热门 余弦相似度均值: {np.mean(cos_hl_list):.4f}")
